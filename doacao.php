            ...
            <div class="box">
              <div>
                ...
                <div class="detail-box">
                  ...
                  <a href="login.html?id-igreja=100&id-contato=123456" type="button"
                    class="btn btn-secondary d-grid gap-2 col-6 mx-auto">
                    Doar
                  </a>
            ...
            <div class="box">
              <div>
                ...
                <div class="detail-box">
                  ...
                  <!-- Button trigger modal -->
                  <button id="42" type="button" class="btn btn-secondary d-grid gap-2 col-6 mx-auto"
            ...
            <div class="box">
              <div>
                ...
                <div class="detail-box">
                  ...
                  <!-- Button trigger modal -->
                  <button type="button" class="btn btn-secondary d-grid gap-2 col-6 mx-auto" data-bs-toggle="modal"
