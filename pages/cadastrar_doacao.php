...
<div class="col-md-3" padding-top="20px">
        ...
        <div class="col-md-12">
          ...
          <form method="POST" action="adicionar_doacao.php">
            ...
            <select class="form-control nice-select wide">
              ...
              <div>
                <label for="ent_beneficiada">Id entidade:</label>
                <input type="text" class="form-control" name="id_ent_beneficiada" id="id_ent_beneficiada" pattern="[0-9]+$" minlength="1" required>
            </div>
            <div class="form-group">        
